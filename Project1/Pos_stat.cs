...
namespace Project1
{
    public partial class Pos_stat : UserControl
    {
            ...
            try
            {
                if (dBManager.GetConnection() == true)
                {
                    using (OracleCommand cmd = new OracleCommand())
                    {
                        ...
                        cmd.CommandText = "select pos_codnms as 직급명, count(*) as 인원수 from information_ljm group by pos_codnms";
        ...
        private void Pos_stat_Load(object sender, EventArgs e)
        {
